...
/*********************************************** */
    ...
    { 
      ...
      $imagen=$this->imagen;
        ...
        $sql = "update usuario set nombre = '$nombre',apellido ='$apellido', email = '$email', login= '$login', password='$password', telefono='$telefono',imagen='$imagen'  where id = $id";
        $resultado = $this->cnx->execute($sql);    
        if(isset($resultado)&&$this->cnx->filas_afectadas()>0)
        {  
           return true;
   ...
   /* ******************** */ 
    ...
    { 
      ...
      $telefono=$this->telefono;
        ...
        $sql = "update usuario set nombre = '$nombre', apellido ='$apellido', email = '$email', login= '$login', password='$password', telefono='$telefono'  where id = $id";
        $resultado = $this->cnx->execute($sql);    
        if(isset($resultado)&&$this->cnx->filas_afectadas()>0)
        {  
           return true;
