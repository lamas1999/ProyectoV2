...
<head>
    ...
    <title>Login</title>
    <link rel="icon" href="plugin/img/iconop.png">
</head>
...
<body>
    ...
    <section class="login-content">
        <img src="plugin/img/logo.png" width="95" height="95" alt="img" srcset="">
        <div class="logo">
            <h1>RossMotors</h1>
        </div>
        <div class="login-box">
            <form class="login-form" action="frmlogin.php" method="POST">
                ...
                <div class="form-group">
                    <label class="control-label">PASSWORD</label> <i class="fa fa-eye" id="show"></i>
