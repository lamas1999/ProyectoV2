...
///Si esta vacia el archivo de fotos solo actualiza la informacion 
    ...
    if (empty($_FILES['foto']['name'])) {
        ...
        $usuario->inicializar($id, $nombre, $apellido, $email, $login, $password, $telefono, null);
        if ($usuario->modificar_sinImg()) {
            header("location:frmperfiluser.php?msg=Modificado correctamente!!!");
        } else {
        ...
        if ($check !== false) {
            ...
            $usuario->inicializar($id, $nombre, $apellido, $email, $login, $password, $telefono, $imagen);
    ...
    /*     $usuario->inicializar($id, $nombre, $email, $direccion, $login, $password, $telefono,$imagen);
    if ($usuario->modificar()) {
        header("location:frmmlogin.php?msg=Modificado correctamente!!!");
    } else {
        $error = "Error al modificar revise los datos !!!";
    } */
}
        ...
        <div class="col-md-12">
            <div class="profile">
                <div class="info">
                    <?php
                    if ($imagen == "") { ?>
                        <img src="../plugin/img/login-default.png" class="img-circle" alt="User Image" />
                    <?php
                    } else { ?>
                ...
                <!--   <div class="tab-pane active" id="user-timeline">
                    <div class="timeline-post">
                        <div class="post-media">
                         ...
                         //   <//?php  
                    //if ($imagen =="") { ?>
                       <img src="../plugin/img/login-default.png" class="imgRedonda" alt="User Image"/>
                     //<//?php
                     //}
                     else { ?>
                       <img src="../fotos/<//?php echo $imagen; ?>" class="imgRedonda" alt="User Image"/>
                    // <//?php
                    // }
                    // ?>
                        </a>
                        ...
                        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" name="form1" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" type="text" name="txtapellido" id="txtapellido" value="<?php echo $apellido; ?>">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-8 mb-4">
                                    <label>E-mail</label>
                                    <input class="form-control" type="text" name="txtemail" value="<?php echo $email; ?>" id="txtemail">
                                </div>

                                <div class="clearfix"></div>
                                <div class="col-md-8 mb-4">
                                    <label>Login</label>
                                    <input class="form-control" type="text" name="txtlogin" value="<?php echo $login; ?>" id="txtlogin">
                                </div>
                                <div class="clearfix"></div>
                                <div class="col-md-8 mb-4">
                                ...
                                <div class="col-md-8 mb-4">
                                    ...
                                    <input class="form-control" type="number" name="telefono" value="<?php echo $telefono; ?>" id="telefono" onkeypress="return solonumeros(event)" onpaste="return false" pattern="[0-9]+">
                                </div>
                                <div class="clearfix"></div>
                                <div class="col-md-8 mb-4">
                                    <label>Foto</label>
                                ...
                                <div class="col-md-8 mb-4">
                                    <?php
                                    if ($imagen == "") { ?>
                                        <img style="border:1px solid #eaeaea;border-radius:5px;" src="../plugin/img/login-default.png" width="128">
                                    <?php
                                    } else { ?>
                            ...
                            <div class="tile-footer">
                                <div class="row">
                                    <div class="col-md-8 col-md-offset-3">
                                        <button class="btn btn-primary" type="submit" name="btnaceptar" id="btnaceptar"><i class="fa fa-fw fa-lg fa-check-circle"></i>Guardar</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="frmperfiluser.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
                                    </div>
                                </div>
                            </div>
                        </form>
